...
test('nuevoConteoRequest arma el payload del contrato', () => {
  const r = nuevoConteoRequest({ texto: 'noventa cajas', bodegaId: 13, operarioId: 'op-1' })
...
test('nuevoConteoRequest respeta la fuente explícita', () => {
  const r = nuevoConteoRequest({ texto: 'aceite', bodegaId: 1, operarioId: 'op-1', fuente: 'voz-tablet' })
